...
const unsigned short int MENU_OPTION_USE_XOR			= 4;
const unsigned short int MENU_OPTION_DISCARD_NETWORk	= 5;
const unsigned short int MENU_OPTION_CLOSE_PROGRAM		= 6;
